...
function landingHTML(themeCss, themeAccent) {
  return '<!DOCTYPE html><html lang="ar" dir="rtl"><head><meta charset="utf-8">' +
    ...
    'window.openSupport=function(){document.getElementById(\'supportModal\').classList.add(\'open\')};' +
    'window.closeSupport=function(){document.getElementById(\'supportModal\').classList.remove(\'open\')};' +
