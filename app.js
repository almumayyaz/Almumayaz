...
function landingHTML(themeCss, themeAccent) {
  return '<!DOCTYPE html><html lang="ar" dir="rtl"><head><meta charset="utf-8">' +
    ...
    'var m=document.getElementById(\'supportModal\'),fb=document.getElementById(\'openSupportBtn\');' +
    'if(fb)fb.addEventListener(\'click\',function(){m&&m.classList.add(\'open\')});' +
    'if(m)m.querySelector(\'.lp-modal-bg\')&&m.querySelector(\'.lp-modal-bg\').addEventListener(\'click\',function(){m.classList.remove(\'open\')});' +
    'if(m)m.querySelector(\'.lp-modal-close\')&&m.querySelector(\'.lp-modal-close\').addEventListener(\'click\',function(){m.classList.remove(\'open\')});' +
