...
self.addEventListener('activate', function(e) {
  e.waitUntil(self.registration.active ? Promise.resolve() : self.registration.active);
});

firebase.messaging().onBackgroundMessage(function(payload) {
  var title = payload.data && payload.data.title ? payload.data.title : (payload.notification && payload.notification.title ? payload.notification.title : 'المُميز');
  ...
  var clickUrl = payload.data && payload.data.url ? payload.data.url : '/';
