...
function getFirebaseErrorMessage(error) {
  ...
  var code = error.code || (error.errorInfo && error.errorInfo.code) || '';
  if (code && ERROR_MAP[code]) {
    console.error('[Firebase Error]', code, error.message || error);
    return ERROR_MAP[code];
  }
  var msg = error.message || (typeof error === 'string' ? error : '');
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { getFirebaseErrorMessage: getFirebaseErrorMessage, ERROR_MAP: ERROR_MAP, UNKNOWN_ERROR: UNKNOWN_ERROR };
}
